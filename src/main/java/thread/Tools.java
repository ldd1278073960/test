...
public class Tools {
    public static void main(String[] args) {
        ...
        String appcode = "9d06a2e897b54e03b037c0983f01c865"; // 【3】开通服务后 买家中心-查看AppCode
        String no = "775510298333622"; // 【4】请求参数，详见文档描述
        String urlSend = host + path + "?no=" + no + "&type="; // 【5】拼接请求链接
